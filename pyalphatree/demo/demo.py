...
def test_base_cal(data_proxy, codes):
    ...
    print "sum(high, 2)"
    alpha = AlphaArray(codes, ["s = sum(high, 2)"], "s", 0, 3)
    # 今天、昨天、前天数据一共3天
    data = alpha[1:]
    for id, code in enumerate(codes):
