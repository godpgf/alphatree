...
#ifndef PROTOBUF_stock_2eproto_INCLUDED
#define PROTOBUF_stock_2eproto_INCLUDED
...
class StockMeta : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:stp.StockMeta) */ {
 public:
  ...
  // int64 totals = 6;
  void clear_totals();
  static const int kTotalsFieldNumber = 6;
  ::google::protobuf::int64 totals() const;
  void set_totals(::google::protobuf::int64 value);

  // float earningRatios = 7;
  void clear_earningratios();
  static const int kEarningRatiosFieldNumber = 7;
  float earningratios() const;
  void set_earningratios(float value);
 ...
 private:
  ...
  ::google::protobuf::int64 totals_;
  float earningratios_;
...
// int64 totals = 6;
inline void StockMeta::clear_totals() {
  totals_ = GOOGLE_LONGLONG(0);
}
inline ::google::protobuf::int64 StockMeta::totals() const {
  // @@protoc_insertion_point(field_get:stp.StockMeta.totals)
  return totals_;
}
inline void StockMeta::set_totals(::google::protobuf::int64 value) {
  
  totals_ = value;
  // @@protoc_insertion_point(field_set:stp.StockMeta.totals)
}

// float earningRatios = 7;
inline void StockMeta::clear_earningratios() {
  earningratios_ = 0;
}
inline float StockMeta::earningratios() const {
  // @@protoc_insertion_point(field_get:stp.StockMeta.earningRatios)
  return earningratios_;
}
inline void StockMeta::set_earningratios(float value) {
  
  earningratios_ = value;
  // @@protoc_insertion_point(field_set:stp.StockMeta.earningRatios)
}
...
#endif  // PROTOBUF_stock_2eproto_INCLUDED
