    ...
    public:
        ...
        void initialize(size_t sampleSize, size_t featureSize) {
            ...
            if (featureSize > maxFeatureSize_ || sampleSize > maxSampleSize_) {
                delete[]feature;
                size_t featureDataSize = std::max(featureSize, maxFeatureSize_) * std::max(sampleSize, maxSampleSize_);
                ...
                maxSampleSize_ = std::max(maxSampleSize_, sampleSize);
                maxFeatureSize_ = std::max(maxFeatureSize_, featureSize);
            }
        }
